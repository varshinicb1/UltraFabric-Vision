...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Industrializing AI Fabric Defect Detection using FabricAI Pro Suite}
\subCode{XX367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Varshini C B}
\stuUSNA{1RV23EE056}
\stuNameB{Navi Deepak Gurupad}
\stuUSNB{1RV24EC410}
\stuNameC{Ayush}
\stuUSNC{1RV24CD400}
\stuNameD{Sanjana T M}
\stuUSND{1RV23EC131}
% Only four team members; slots E and F intentionally left unset so they do not render.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Guide Related commands
%% Internal Guide %%
% Have to give both short form and long of Department Name
\guideNameA{Dr. Jyothi Shetty}
